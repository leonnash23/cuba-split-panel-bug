...
public class SplittestTestContainer extends TestContainer {

    public SplittestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/splittest/app.properties",
    ...
    public static class Common extends SplittestTestContainer {

        public static final SplittestTestContainer.Common INSTANCE = new SplittestTestContainer.Common();
